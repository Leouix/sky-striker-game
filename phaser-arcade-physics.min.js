...
(function () {
    ...
    window.console || (window.console = {}, window.console.log = window.console.assert = function () {
        ...
        setTo: function (a, b, c, d) {
            ...
            var c = this.start.x, d = this.start.y;
        ...
        start: function () {
            ...
            this.touchLockCallbacks.push({callback: a, context: b})
    ...
    c.Math.degToRad = function (a) {
        ...
        play: function (a, b, c) {
            ...
            if (b) this.currentFrame = this._frameData.getFrame(this._frames[this._frameIndex]), this.currentFrame && this._parent.setFrame(this.currentFrame); else {
        ...
        addFrame: function (a) {
            ...
            if ("undefined" == typeof b && (b = !0), "undefined" == typeof c && (c = []), "undefined" == typeof a || 0 === a.length) for (var d = 0; d < this._frames.length; d++) c.push(this._frames[d]); else for (var d = 0; d < a.length; d++) c.push(b ? this.getFrame(a[d]) : this.getFrameByName(a[d]));
            return c
        }, getFrameIndexes: function (a, b, c) {
            if ("undefined" == typeof b && (b = !0), "undefined" == typeof c && (c = []), "undefined" == typeof a || 0 === a.length) for (var d = 0; d < this._frames.length; d++) c.push(this._frames[d].index); else for (var d = 0; d < a.length; d++) b ? c.push(this._frames[a[d]].index) : this.getFrameByName(a[d]) && c.push(this.getFrameByName(a[d]).index);
            return c
        }
        ...
        addCanvas: function (a, b, c) {
            ...
            this._videos[a] = {url: b, data: c, isBlob: d, locked: !0}, this._resolveURL(b, this._videos[a])
            ...
            for (var b = [this._canvases, this._sounds, this._videos, this._text, this._json, this._xml, this._textures, this._physics, this._tilemaps, this._binary, this._bitmapDatas, this._bitmapFont], c = 0; c < b.length; c++) for (var a in b[c]) delete b[c][a];
        ...
        setPreloadSprite: function (a, b) {
            ...
            return "undefined" == typeof b && (b = null), "undefined" == typeof d && (d = null), "undefined" == typeof e && (e = c.Physics.LIME_CORONA_JSON), b || d || (b = a + ".json"), d ? ("string" == typeof d && (d = JSON.parse(d)), this.game.cache.addPhysicsData(a, null, d, e)) : this.addToFileList("physics", a, b, {format: e}), this
        ...
        bitmapFont: function (a, b, c, d, e) {
            ...
            for (j = 0; j < l.length; j++) {
                var m = parseInt(l[j].getAttribute("first"), 10), n = parseInt(l[j].getAttribute("second"), 10),
            ...
            Object.keys(b.chars).forEach(function (c) {
                var d = b.chars[c], e = new PIXI.Rectangle(d.x, d.y, d.width, d.height);
        ...
        soundHasUnlocked: function (a) {
            ...
            if (this._sound && this.isPlaying && !this.allowMultiple && (this.override || e)) if (this.usingWebAudio) if (this._sound.disconnect(this.externalNode ? this.externalNode : this.gainNode), "undefined" == typeof this._sound.stop) this._sound.noteOff(0); else try {
                this._sound.stop(0)
            } catch (f) {
            ...
            if (this.isPlaying && this._sound) if (this.usingWebAudio) if (this._sound.disconnect(this.externalNode ? this.externalNode : this.gainNode), "undefined" == typeof this._sound.stop) this._sound.noteOff(0); else try {
                this._sound.stop(0)
            } catch (a) {
            } else this.usingAudioTag && (this._sound.pause(), this._sound.currentTime = 0);
        ...
        create: function (a, b, c, d, e, f) {
            ...
            var i = null;
            if (("undefined" == typeof b || null === b) && (b = a), b instanceof c.BitmapData) i = b.canvas; else {
            ...
            for (var k, l = !1, m = 0, n = this.objects[a].length; n > m; m++) if ("undefined" != typeof this.objects[a][m].gid && "number" == typeof b && this.objects[a][m].gid === b && (l = !0), "undefined" != typeof this.objects[a][m].id && "number" == typeof b && this.objects[a][m].id === b && (l = !0), "undefined" != typeof this.objects[a][m].name && "string" == typeof b && this.objects[a][m].name === b && (l = !0), l) {
        ...
        parse: function (a, b, d, e, f, g) {
            ...
            for (var s = [], t = [], f = 0; f < a.tilesets.length; f++) {
                ...
                if (u.image) {
                    ...
                    for (var f in u.tiles) {
                        var r = u.tiles[f].image, k = u.firstgid + parseInt(f, 10);
                        w.addImage(k, r)
                    }
                    t.push(w)
                }
            ...
            for (var x = {}, y = {}, f = 0; f < a.layers.length; f++) if ("objectgroup" === a.layers[f].type) {
                x[a.layers[f].name] = [], y[a.layers[f].name] = [];
                for (var z = 0, p = a.layers[f].objects.length; p > z; z++) if (a.layers[f].objects[z].gid) {
                    var A = {
            ...
            for (var f = 0; f < d.tilesets.length; f++) for (var u = d.tilesets[f], l = u.tileMargin, C = u.tileMargin, D = 0, E = 0, F = 0, o = u.firstgid; o < u.firstgid + u.total && (d.tiles[o] = [l, C, f], l += u.tileWidth + u.tileSpacing, D++, D !== u.total) && (E++, E !== u.columns || (l = u.tileMargin, C += u.tileHeight + u.tileSpacing, E = 0, F++, F !== u.rows)); o++) ;
